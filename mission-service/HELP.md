...
* The original package name 'pl.naval-mission-command-system.mission-service' is invalid and this project uses 'pl.naval_mission_command_system.mission_service' instead.
